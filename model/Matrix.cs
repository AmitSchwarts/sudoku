...
namespace sudoku.model
{
    public class Matrix
    {
        ...
        {
            byte[,] coverMat = new byte[size*size*size , size*size*NUM_OF_CONSTRAINTS]; // Initialize the cover matrix
            ...
            int currentBoxConstraintColumn = 3 * size * size; // The current column for the square constraint
            ...
            for (int row = 0; row < size; row++) // go through all the rows in the matrix
            {
                ...
                for (int col = 0; col < size; col++) // go through all the cols in the matrix
                {
                    ...
                    for (byte number = 1; number <= size; number++) // go through all the  in the matrix
                    {
