...
{
    // class validation: containe static functions whose purpose is to check
    // whether a certain string is correct in a specific respect that is tested in the function
    internal static class PreValidation
    {
        // gets a board string
